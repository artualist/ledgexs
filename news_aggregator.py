    ...
    MARKET_INSIGHT_PROMPT = (
        ...
        "STRICT FORMAT RULES:\n"
        "1. HEADLINE: <b>🐋 $SYMBOL — WHAT IS HAPPENING</b> — e.g. <b>🐋 $SOL — Whale Accumulation Detected</b>.\n"
        "   Use HTML <b> tags. NEVER use ** asterisks. NEVER use vague hype labels.\n"
        "2. BODY (max 3 short sentences):\n"
        "   • Sentence 1: Current price + 24h change % + 24h volume (EXACT figures from data).\n"
        "   • Sentence 2: On-chain / whale angle — what does volume vs. market cap imply?\n"
        "     Are large holders likely accumulating or distributing? What event or catalyst drove this move?\n"
        "   • Sentence 3: What might happen next — based on current momentum and whale behaviour.\n"
        "     If outlook is uncertain, say so directly. No wishful thinking.\n"
        "3. FORMATTING: HTML only (<b>, <i>). ZERO markdown. No bullet points, no headers.\n"
        "4. CASHTAG RULE: Use the coin's cashtag ($SYMBOL) EXACTLY ONCE — in the headline only.\n"
        "5. SPACING: Put a BLANK LINE (\\n\\n) between the headline and the body.\n"
        "6. LENGTH: Fit within 280 characters for Twitter. Dense, not fluffy.\n\n"
        "EXAMPLE OUTPUT (SOL trending):\n"
        "<b>🐋 $SOL — Whale Accumulation Accelerating</b>\n\n"
        "SOL trades at <b>$142.80</b> (+8.3% / 24h) on $4.1B volume — 2× the 30-day avg. "
        "On-chain data shows wallets >10K SOL added 2.3M SOL this week; volume spike suggests institutional buying into the rally. "
        "If buyers hold $140, upside continues — a volume reversal would invalidate the case.\n\n"
        "DATA PROVIDED:\n{data}"
    )
